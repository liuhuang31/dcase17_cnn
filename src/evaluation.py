...
class DCASE2016_EventDetection_SegmentBasedMetrics(EventDetectionMetrics):
    ...
    def results(self):
        ...
        print('overall_ER_Nref:',self.overall['ER'], self.overall['Nref'])
        print('overall_Ntp_Nsys:',self.overall['Ntp'], self.overall['Nsys'])
        ...
        for class_id, class_label in enumerate(self.class_list):
            ...
            print('class_label:',class_label,self.class_wise[class_label]['Nfn'] + self.class_wise[class_label]['Nfp'],self.class_wise[class_label]['Nref'] + self.eps)#lhh
